...
def iter_lin_solve(A, b, y=None, mean=None, cov=None, data_cov=None,
                   method="mud", num_epochs=1, idx_order=None):
    """
...
def data_prob(lam, qoi, qoi_true=None, measurements=None, std_dev=None,
               sample_dist='uniform', domain=None, lam_ref=None, times=None,
               sensors=None, method='wme',
...
def iter_data_prob(lam, qoi, data, domain, sd=0.05, weights=None, num_it=1, pca_components=None, init_dist=dists.uniform(loc=0, scale=1)):
    """
